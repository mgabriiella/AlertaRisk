  ...
  return (
    <div className="home">
            ...
            <div>
              ...
              <div className="feature">
                ...
                <div className="feature-text">
                  ...
                  <p>
                    Receba avisos instantâneos sobre chuvas fortes e áreas de
                    risco, diretamente no seu celular.
                  </p>
                </div>
              </div>
              ...
              <div className="feature">
                ...
                <div className="feature-text">
                  ...
                  <p>
                    Nosso objetivo é levar proteção para todas as comunidades,
          ...
          <div className="grid">
            <div className="text-content">
              ...
              <p className="map-description">
                Visualize áreas de risco em tempo real
              </p>
              <button className="explore-btn">
                <Link to="/mapa" style={{ textDecoration: 'none', color: 'inherit' }}>EXPLORAR</Link>
                </button>
            </div>
      ...
      <section className="benefits">
        <div className="container">
          <h1>Benefícios de usar o AlertaRisk</h1> {/* Corrigido o typo "Benefíciiios" */}
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <p>
                Proteja seus bens, evite perdas e agilize a recuperação em
                riscos.
              </p>
            </div>
            ...
            <div className="benefit-card">
              ...
              <p>
                Sinta-se mais seguro e viva com tranquilidade. Contribua para
            ...
            <div className="benefit-card">
              ...
              <p>
                Receba alertas precoces para evacuar áreas de risco a tempo.
                Saiba como agir em emergências e salvar vidas.
              </p>
            </div>
            ...
            <div className="benefit-card">
              ...
              <p>
                Tenha informações precisas para decisões seguras e planejamento
                estratégico. Identifique e previna riscos de forma eficiente.
              </p>
            </div>
            ...
            <div className="benefit-card">
              ...
              <p>
                Ajuda governos a focar recursos em áreas vulneráveis, reduzindo
                custos e investindo na prevenção.
              </p>
            </div>
            ...
            <div className="benefit-card">
              ...
              <p>
                Receba atualizações no WhatsApp e esteja sempre preparado para
                agir.
              </p>
            </div>
          </div>

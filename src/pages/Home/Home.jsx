        ...
        <div className="container">
          ...
          <div className="benefits-grid">
            ...
            <div className="benefit-card">
              ...
              <p>Informações precisas para decisões seguras e planejamento.</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">
              ...
              <p>Ajuda governos a focar em áreas vulneráveis, reduzindo custos.</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">
              ...
              <p>Atualizações no WhatsApp para ação imediata.</p>
            </div>
          </div>
        </div>
      </section>
